  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        <h2 className="text-lg md:text-4xl mb-4 text-slate-900 font-bold max-w-4xl">
          Our Journey
        </h2>
        <p className="text-slate-600 text-sm md:text-base max-w-lg">
          From a simple idea to connecting millions worldwide. Here's how Connectify 
          evolved to become your go-to video calling platform.
        </p>
      </div>
          ...
          >
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
              <div className="h-10 absolute left-3 md:left-3 w-10 rounded-full bg-white flex items-center justify-center">
                <div className="h-4 w-4 rounded-full bg-gradient-to-r from-blue-500 to-purple-500 border-2 border-white shadow-lg" />
              </div>
